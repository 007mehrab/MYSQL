...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 class="text-danger text-center">Registration</h1>
      ...
      <?php if($_GET['req']!=''){ ?>
        ...
        <p class="alert alert-danger"><?php echo $_GET['req'];?></p>

      <?php } ?>

<!-- Form Open-->
       
        <form class="form-horizontal" action="includes/register_submit.php" method="post">
